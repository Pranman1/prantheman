...
export default function Intro() {
  ...
  return (
    <section ref={ref} id='home' className='scroll-mt-[100rem] my-28'>
        ...
        >
        <h1 className="md:text-10xl sm:text-10xl text-10xl font-bold text-white">
        ...
        <div className="Animated">
            <h1 className="md:text-8xl sm:text-6xl text-6xl font-bold text-black md:py-6 py-3">
                <TypeAnimation className="Animated"
                  ...
                  sequence={["Student", 2000, "Developer", 2000,"Entrepreneur",2000, "Leader",2000, "Innovator",2000]}
                  wrapper="span"
                  speed={65}
                  cursor={true}
                  repeat={Infinity}
